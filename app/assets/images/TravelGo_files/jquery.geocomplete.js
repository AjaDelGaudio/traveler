...
<div id="container">
  <h2>No route matches [GET] &quot;/javascripts/jquery.geocomplete.js&quot;</h2>

  
<p><code>Rails.root: /Users/Aja/projects/breakable-toy/travel-go</code></p>
...
<table id='route_table' class='route_table'>
  ...
  <td data-route-reqs='bucket_lists#index'>
    bucket_lists#index
  </td>
</tr>
<tr class='route_row' data-helper='path'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='all_public_bucket_lists'>
      all_public_bucket_lists<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/bucket_lists/all_public(.:format)' data-regexp='^\/bucket_lists\/all_public(?:\.([^\/.?]+))?$'>
    /bucket_lists/all_public(.:format)
  </td>
  <td data-route-reqs='bucket_lists#all_public'>
    bucket_lists#all_public
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='bucket_lists'>
      bucket_lists<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/bucket_lists(.:format)' data-regexp='^\/bucket_lists(?:\.([^\/.?]+))?$'>
    /bucket_lists(.:format)
  </td>
  <td data-route-reqs='bucket_lists#index'>
    bucket_lists#index
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='bucket_lists#create'>
    bucket_lists#create
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_bucket_list'>
      new_bucket_list<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/bucket_lists/new(.:format)' data-regexp='^\/bucket_lists\/new(?:\.([^\/.?]+))?$'>
    /bucket_lists/new(.:format)
  </td>
  <td data-route-reqs='bucket_lists#new'>
    bucket_lists#new
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_bucket_list'>
      edit_bucket_list<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/bucket_lists/:id/edit(.:format)' data-regexp='^\/bucket_lists\/([^\/.?]+)\/edit(?:\.([^\/.?]+))?$'>
    /bucket_lists/:id/edit(.:format)
  </td>
  <td data-route-reqs='bucket_lists#edit'>
    bucket_lists#edit
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='bucket_list'>
      bucket_list<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/bucket_lists/:id(.:format)' data-regexp='^\/bucket_lists\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /bucket_lists/:id(.:format)
  </td>
  <td data-route-reqs='bucket_lists#show'>
    bucket_lists#show
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='bucket_lists#update'>
    bucket_lists#update
  </td>
</tr>
<tr class='route_row' data-helper='path'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='bucket_lists#destroy'>
    bucket_lists#destroy
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='all_public_adventures'>
      all_public_adventures<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/adventures/all_public(.:format)' data-regexp='^\/adventures\/all_public(?:\.([^\/.?]+))?$'>
    /adventures/all_public(.:format)
  </td>
  <td data-route-reqs='adventures#all_public'>
    adventures#all_public
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='search_adventures'>
      search_adventures<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/adventures/search(.:format)' data-regexp='^\/adventures\/search(?:\.([^\/.?]+))?$'>
    /adventures/search(.:format)
  </td>
  <td data-route-reqs='adventures#search'>
    adventures#search
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='adventures'>
      adventures<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/adventures(.:format)' data-regexp='^\/adventures(?:\.([^\/.?]+))?$'>
    /adventures(.:format)
  </td>
  <td data-route-reqs='adventures#index'>
    adventures#index
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='adventures#create'>
    adventures#create
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_adventure'>
      new_adventure<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/adventures/new(.:format)' data-regexp='^\/adventures\/new(?:\.([^\/.?]+))?$'>
    /adventures/new(.:format)
  </td>
  <td data-route-reqs='adventures#new'>
    adventures#new
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_adventure'>
      edit_adventure<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/adventures/:id/edit(.:format)' data-regexp='^\/adventures\/([^\/.?]+)\/edit(?:\.([^\/.?]+))?$'>
    /adventures/:id/edit(.:format)
  </td>
  <td data-route-reqs='adventures#edit'>
    adventures#edit
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='adventure'>
      adventure<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/adventures/:id(.:format)' data-regexp='^\/adventures\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /adventures/:id(.:format)
  </td>
  <td data-route-reqs='adventures#show'>
    adventures#show
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='adventures#update'>
    adventures#update
  </td>
</tr>
<tr class='route_row' data-helper='path'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='adventures#destroy'>
    adventures#destroy
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_bucket_list_adventure'>
      edit_bucket_list_adventure<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/bucket_list_adventures/:id/edit(.:format)' data-regexp='^\/bucket_list_adventures\/([^\/.?]+)\/edit(?:\.([^\/.?]+))?$'>
    /bucket_list_adventures/:id/edit(.:format)
  </td>
  <td data-route-reqs='bucket_list_adventures#edit'>
    bucket_list_adventures#edit
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='bucket_list_adventure'>
      bucket_list_adventure<span class='helper'>_path</span>
  </td>
  <td data-route-verb='PATCH'>
    PATCH
  </td>
  <td data-route-path='/bucket_list_adventures/:id(.:format)' data-regexp='^\/bucket_list_adventures\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /bucket_list_adventures/:id(.:format)
  </td>
  <td data-route-reqs='bucket_list_adventures#update'>
    bucket_list_adventures#update
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name=''>
...
<div class="details">
  ...
  <div id="session_dump" style="display:none"><pre>_csrf_token: &quot;9ADsJDoevVb49p8xSM7FC3ONwIKKrnQ2ptzGWA+PMQo=&quot;
session_id: &quot;ffabdf40bee93306fed5c63c9b1ff8b8&quot;
warden.user.user.key: [[1], &quot;$2a$10$k9IRStYwRk6a7UNEtgxTg.&quot;]</pre></div>
</div>
...
<div id="console"
  data-remote-path='console/repl_sessions/fb64eac91316f31cd27032487b6bb73d'
  data-initial-prompt='>> '>
</div>
